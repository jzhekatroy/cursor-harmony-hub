...
# Создаем скрипт внутри контейнера в рабочей директории
...
# Запускаем скрипт из рабочей директории
docker compose exec beauty-booking sh -c "cd /app && node temp-change-password.js '$EMAIL' '$NEW_PASSWORD'"
